...
public class videoadapter2 extends RecyclerView.Adapter<videoadapter2.CustomViewHolder> {

    private ArrayList<videodata> arrayList;

    public videoadapter2(ArrayList<videodata> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public videoadapter2.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull videoadapter2.CustomViewHolder holder, int position) {
